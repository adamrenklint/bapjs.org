...
function makeControls () {
  ...
  play.onclick = function (ev) {
    ...
    // TODO: what if there are more than one editors on a page, need to send which one!
    // TODO: on stop, send playback time
    ga('send', 'event', 'editor', 'control-playback', bap.clock.playing);
  };
